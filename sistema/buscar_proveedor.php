...
<body>
	...
	<section id="container">
		...
		<a href="registro_cliente.php" class="btn_new"> <i class="fa fa-plus"></i>Crear usuario</a>
		...
		<table>
			...
			<td>
				...
				<a class="link_delete" href="eliminar_confirmar_proveedor.php?id=<?php echo $data['codproveedor'];?>"> <i class="fa fa-trash"></i> Eliminar</a>
