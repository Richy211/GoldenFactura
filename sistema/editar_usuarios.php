...
if(!empty($_POST))
{
	...
	if(empty($_POST['nombre']) || empty($_POST['correo']) || empty($_POST['usuario']) || empty($_POST['rol']))
	{
		...
		if($result > 0){
			...
			if($sql_update){
				$alert='<p class="msg_save">Usuario se actualizó correctamente.</p>';
			}else{
...
$sql = mysqli_query($conection,"SELECT u.idusuario, u.nombre, u.correo,u.usuario, (u.rol) 
	as idrol, (r.rol) as rol FROM usuario u
	INNER JOIN rol r
	on u.rol = r.idrol
